...
$q = read_json();
$speciality = trim((string)($q["speciality"] ?? ""));
if ($speciality === "") json_response(400, ["ok"=>false, "error"=>"Missing speciality"]);
...
switch ($key) {
  case "ORTHOPEDICS":
    ...
    $aliases[] = "ORTHOPAEDIC";
    break;
  case "OPHTHALMOLOGY": $aliases[] = "OPHTHALMOLOGIST"; break;
  case "CARDIOLOGY":    $aliases[] = "CARDIOLOGIST"; break;
  case "NEUROLOGY":     $aliases[] = "NEUROLOGIST"; break;
  case "DERMATOLOGY":   $aliases[] = "DERMATOLOGIST"; break;
  case "PEDIATRICS":    $aliases[] = "PEDIATRICIAN"; break;
